...
(function () {
  ...
  function buildButtons(slug) {
    ...
    inter.className =
      "inter-btn px-3 py-1 rounded bg-white text-gray-900 border";
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    buttons.addEventListener("click", function (e) {
      ...
      if (ver === "interlinear") {
        ...
        const torah = document.querySelector(
          '.bible-block[data-section="torah"]'
        );
        const gospel = document.querySelector(
          '.bible-block[data-section="gospel"]'
        );
        [torah, gospel].forEach((block) => {
          ...
          block
            .querySelectorAll(".version.leb, .version.nirv")
            .forEach((el) => el.classList.add("hidden"));
          // reveal server-side interlinear panels
          block
            .querySelectorAll(".server-interlinear")
